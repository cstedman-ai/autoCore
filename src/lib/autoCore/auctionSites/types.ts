/** Shared types for autoCore auction and salvage sites. */
...
export type AuctionSite = {
  ...
  name: string;
  /** Description of the auction platform and inventory. */
  description: string;
  ...
  /** Notable lot or auction locations, or 'Nationwide' / 'Global'. */
  lotLocations: string[];
};
