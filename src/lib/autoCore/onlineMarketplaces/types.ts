/** Shared types for autoCore automotive online-marketplace profiles. */
...
export type OnlineMarketplace = {
  /** Display name of the online car marketplace or indexer. */
  name: string;
  /** Description of the marketplace and what it offers. */
  description: string;
