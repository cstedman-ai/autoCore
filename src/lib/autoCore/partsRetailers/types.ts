/** Shared types for autoCore automotive parts retailers and distributors. */
...
export type PartsRetailer = {
  /** Display name of the parts retailer or distributor. */
  name: string;
  /** Description of the retailer and what it offers. */
  description: string;
  ...
  /** Automotive brands they primarily cater to (e.g., 'All', 'Domestic', 'Import', specific brands). */
